...
knitr::opts_chunk$set(echo = TRUE,fig.path = "_imgs/")
...
gf_col(median~State,data=head(ibuByState,10), color=~median,title="Top 10 Median IBU by State")
...
gf_col(median~State,data=head(abvByState,10),color=~median, title="Top 10 Median ABV by State")
